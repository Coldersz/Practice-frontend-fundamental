class SearchBar extends HTMLElement {
    ...
    /**
     * #Note :
     * Karena di dalam elemen ini terdapat <button> yang harus memiliki sebuah event ketika ia diklik,
     * maka kita harus menyediakan setter.
    ...
    render() {
        ...
        this._shadowDOM.querySelector("#searchElement").addEventListener("change", this._clickEvent)
    }
}
